        ...
        <section className='my-44 lg:flex lg:justify-center grid grid-cols-1 gap-5  items-center lg:gap-20'>
           <Link to={''}>
                <div className=" bg-headerFooterColor px-10 py-5 rounded">
                    ...
                    <h2 className=" text-lg mt-4 text-center uppercase">Customers</h2>
                    <div className="text-2xl mt-4 flex justify-center"><CountUp end={3500} duration={3} /><span>+</span></div>
                </div>
           </Link>
            <Link to={''}>
                <div className=" bg-headerFooterColor px-10 py-5 rounded">
                   <MdTopic className="text-5xl mx-auto "/>
                    ...
                    <h2 className="text-lg mt-4 text-center uppercase">Books</h2>
                    <div className="text-2xl mt-4 flex justify-center"><CountUp end={110} duration={3} /><span>+</span></div>
                </div>
            </Link>
           <Link to={''}>
                <div className=" bg-headerFooterColor px-10 py-5 rounded">
